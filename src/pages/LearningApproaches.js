  ...
  return (
    <>
      ...
      >
        ...
        <p style={{ fontSize: '1.3em', color:'#1b1d1e' }}>Once kinesthetic learners can physically sense what they’re studying, abstract ideas and difficult concepts become easier to understand.</p>   </Card>
    </>)
}
